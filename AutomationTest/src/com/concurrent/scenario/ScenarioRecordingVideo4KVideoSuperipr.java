...
public class ScenarioRecordingVideo4KVideoSuperipr implements IScenario{
    ...
    public ScenarioRecordingVideo4KVideoSuperipr(AcceptanceTestCase testCase){
	...
	public void doBegin() throws Exception {
		...
		boolean subButton = commonModule.waitForId(moduleData.get("Common_Record_Button_Id"), 5000);
		if(subButton){
	...
	public void doAfter() throws UiObjectNotFoundException {
				...
				//AcceptanceTestCase.assertTrue("Video recording failed", commonModule.waitForResourceId("com.sonyericsson.android.camera:id/recording_time", 5000));
				commonModule.wait(10);
				AcceptanceTestCase.assertTrue("Camera display incorrectly", commonModule.waitForResourceId(moduleData.get("Common_Record_Button_Id"), 10*1000));
				commonModule.clickResourceId(moduleData.get("Common_Record_Button_Id"));

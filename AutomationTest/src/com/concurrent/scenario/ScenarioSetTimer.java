...
public class ScenarioSetTimer implements IScenario{
    ...
    public ScenarioSetTimer(AcceptanceTestCase testCase) throws PropertyNotFoundException{
    ...
    public void doAfter() throws UiObjectNotFoundException{ 
		...
		Assert.assertTrue("There is no Timer.",
				commonModule.waitForText("Timer", 5000));
    	
		commonModule.clickText("Timer");
		
		Assert.assertTrue("Timer stopped.",
	...
	public void doBegin() throws UiObjectNotFoundException{
		...
		if (!commonModule
			...
			IAlarm.switchAlarmTabByDescription("Timer");
		}

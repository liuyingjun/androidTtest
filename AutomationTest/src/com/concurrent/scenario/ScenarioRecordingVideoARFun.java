...
public class ScenarioRecordingVideoARFun implements IScenario{
    ...
    public ScenarioRecordingVideoARFun(AcceptanceTestCase testCase){
	...
	public void doBegin() throws Exception {
		...
		camera.selectOneEffectFromCameraSettings("AR fun");

...
public class ScenarioDeleteMultipleFilesOfficeSuite implements IScenario{
    ...
    public ScenarioDeleteMultipleFilesOfficeSuite(AcceptanceTestCase testCase) throws PropertyNotFoundException{
	...
	public void doBegin() throws UiObjectNotFoundException{
		...
		officeSuite.operationAllFiles("delete");
